...
public static class CleanCommand
{
    public static Command Create()
    {
        ...
        {
            Description = "Path to a .nettrace file or directory containing traces"
        };
        ...
        command.SetAction(async (ParseResult parseResult, CancellationToken cancellationToken) =>
        {
            ...
            await Execute(path, cancellationToken).ConfigureAwait(false);
        });
        return command;
    }

    private static async Task Execute(string path, CancellationToken cancellationToken)
    {
